...
import img2 from '../../Image/Footer/footer-img.png'
...
function Footer() {
  ...
  return (
    <Flex justify={{ base: 'flex-start', sm: 'center' }} bg={'#000'} w={'100%'} color={"white"} py={10} mt={'40'}>
      <SimpleGrid columns={{ base: 1, sm: 2, lg: 5 }} gap={8} w={'80%'} mx={'auto'} justifyContent={'space-evenly'}>
      {/* 1st Column Image And Text */}
        <Box>
          <Image src={img} color={"white"} w={70} h={70}  />
        ...
        <Flex direction={"column"} color={"white"} textTransform={"capitalize"} fontSize={"14px"}>
          <Heading fontSize={26} fontFamily={'Montserrat'}>Quick Links</Heading>
        ...
        <Flex direction={"column"} mt={{ base: 8, sm: 0 }}>
          <Heading fontSize={26} fontFamily={'Montserrat'}>Contact details</Heading>
        ...
        <Flex direction={"column"}>
          <Heading fontSize={26} fontFamily={'Montserrat'}>Follow us</Heading>
        ...
        <Flex direction={"column"} mt={{ base: 8, lg: 0 }}>
          <Heading fontSize={26} fontFamily={'Montserrat'}>Our Location</Heading>
