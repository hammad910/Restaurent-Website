            ...
            <Box pt={14} bgColor="secondary.100" w={'100%'}>
                <Flex w="80%" mx={'auto'} direction={{ base: 'column', lg: 'row' }}>
                    <Flex direction="column" mt={20}>
                        ...
                        <Flex w="100%" mx="auto" pt={14} flexDir={{ base: 'column', lg: 'row' }}>
                            <SimpleGrid columns={{ base: 1, md: 2, lg: 3 }} gap={4} w="100%">
                                {/* 1st card */}
                                <Box
                                    boxShadow="2xl"
                                    rounded="2xl"
                                    _hover={{ cursor: 'pointer', color: 'white', bgColor: '#f7a010' }}
                                    data-aos="slide-up"
                                    data-aos-duration="6000"
                                >
                                    <Box w={{ base: '90%', md: '80%' }} mx="auto" pt={4}>
                                        <Flex>
                                            <Icon w="40%" h="100%">
                                                <FaLocationDot />
                                            </Icon>
                                ...
                                >
                                    <Box w={{ base: '90%', md: '80%' }} mx="auto" pt={4}>
                                        ...
                                        <Text fontSize={{ base: 16, lg: 18 }} fontWeight="bold" py={2}>
